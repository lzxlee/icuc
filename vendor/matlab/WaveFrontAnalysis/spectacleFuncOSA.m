...
function [Prescription] = spectacleFuncOSA(PARAMS,c);
...
cylinder = 2*Acoeff/((PARAMS.PupilFitSize/2000)^2);
defocus = 2*Dcoeff/((PARAMS.PupilFitSize/2000)^2);
...
Prescription.Sphere = -1*defocus;
Prescription.Cylinder = -1*cylinder;
