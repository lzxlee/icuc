%This is a better way to transfor the coefficients for different pupil sizes. 
%The function is from Linda Lundstrom. This transform is more useful since
%it allows you to remove tilt and defocus terms from the new set of coefficients. 
%function C2=TransformC(C1,dia1, dia2,tx,ty,thetaR)
